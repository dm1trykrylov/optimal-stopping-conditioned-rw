> For the **English version** of this README, see [README_en.md](README_en.md).
...
## Компиляция презентаций и отчётов и воспроизведение результатов

Для компиляции pdf-файлов можно использовать Makefile. 
Код для численный экспериментов - в [main.ipynb](main.ipynb), реализация рекурсивных вычислений для теоретической модели - в [conditioned_random_walk.py](conditioned_random_walk.py).
