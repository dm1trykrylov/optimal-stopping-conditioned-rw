Без ограничения общности можно предполагать симметричные границы, так как несимметричные границы можно свести к симметричным, см. рис. \ref{s01:fig:rotation_example}. \textcolor{red}{Здесь будет описан переход}.

\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.9\linewidth]{./images/rotation_example.png}
	\caption{Пример перехода к симметричным границам}
	\label{s01:fig:rotation_example}
\end{figure}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\linewidth]{./images/mnk_example.png}
	\caption{Пример вычисления $m(n, k)$ для N = 6 и ограничений $ -2 \leq X_n \leq 2 + n$}
